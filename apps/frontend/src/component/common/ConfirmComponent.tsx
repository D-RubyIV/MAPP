...
const ConfirmComponent = ({ onDelete, isOpen, setIsOpen, targert }: { onDelete: any, isOpen: boolean, setIsOpen: any, targert: string }) => {
    return (
        <div className={`fixed left-1/2 bg-white border-4 ring-2 border-double border-gray-300 rounded-t-2xl -translate-x-1/2 w-5/6 transition-all duration-300 ${isOpen ? "bottom-1" : "-bottom-full"}`}>
