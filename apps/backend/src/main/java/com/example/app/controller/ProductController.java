...
public class ProductController {
    ...
    @PostMapping("")
    public ResponseEntity<?> add(@Valid @RequestBody ProductModel entity, BindingResult bindingResult) throws Exception {
        if (bindingResult.hasErrors()) {
            throw new BindException(bindingResult);
        }
        if (productRepository.findByName(entity.getName()) != null) {
    ...
    @PutMapping("{id}")
    public ResponseEntity<?> update(@Valid @RequestBody ProductModel entity, @PathVariable int id, BindingResult bindingResult) throws Exception {
